...
const Cards = () => {
  const products = [
    { title: 'Charlie', image: Single, link: 'https://reyluxeyewear.mitiendanube.com/productos/charlie/' },
    { title: 'Edgard', image: Double, link: 'https://reyluxeyewear.mitiendanube.com/nuestros-lentes/edgard/' },
    { title: 'Albert', image: Triple, link: 'https://reyluxeyewear.mitiendanube.com/productos/albert-brown-sugar/' },
  ];
      ...
      <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
        {products.map((product, index) => (
          ...
          >
            ...
            <p className='text-center text-4xl font-bold'>$72.000</p>
